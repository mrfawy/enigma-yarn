...
public class Client {
	...
	public Client(Configuration conf) throws Exception {
		this("com.tito.enigma.ApplicationMaster", conf);
	}
	...
	public boolean init(String[] args) throws ParseException {
		...
		appName = cliParser.getOptionValue("appname", "engima-yarn");
		amPriority = Integer.parseInt(cliParser.getOptionValue("priority", "0"));
		amQueue = cliParser.getOptionValue("queue", "cpsetlh");
		amMemory = Integer.parseInt(cliParser.getOptionValue("master_memory", "200"));
